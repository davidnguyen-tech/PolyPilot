...
public class Program
{
    ...
    public static async Task<int> Main(string[] args)
    {
        ...
        AnsiConsole.Write(new FigletText("PolyPilot").Color(Color.Cyan1));
    ...
    {
        Console.WriteLine("PolyPilot - Multi-Agent Copilot Session Manager");
        Console.WriteLine();
        Console.WriteLine("Usage: PolyPilot [options]");
        Console.WriteLine();
